...
const projectdetails = [
     ...
     //project 11
	{
		id: 11,
		singleProjectHeader: {
            singleProjectTitle: '5 Phut Thuoc Bai - Landing Page',
            singleProjectDate: 'November 2022',
            singleProjectTag: 'Freelance Project',
        },
        projectImages: [
            {
    ...
    //project 7
    {
        id: 7,
        singleProjectHeader: {
            singleProjectTitle: 'Clean Up - Clean Phone Storage Application',
            singleProjectDate: 'May 2022',
            singleProjectTag: 'Freelance Project',
        },
        projectImages: [
    ...
    //project 6
    {
        id: 6,
        singleProjectHeader: {
            singleProjectTitle: 'Behap Website',
